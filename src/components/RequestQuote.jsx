...
// const RequestQuote = () => {
//   return (
//     <div className='w-[90%] flex flex-col md:flex-row mt-6'>
...
//             <div className='flex flex-col gap-2 w-1/2 shadow-xl border-2 border-gray-200 p-4'>
...
//                 </div>
//             </div>
//             <button className='bg-blue-600 hover:bg-blue-900 h-10 px-4 text-white border rounded-2xl'>Download Brochure</button>
//         </div>
//       </div>
//       <div className='w-1/3'>
//         <form className='w-full p-10 bg-blue-600'>
...
//                     <option value="Customise Sofware Solution">Customise Sofware Solution</option>
//                 </select>

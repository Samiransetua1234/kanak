    ...
    <div className='flex flex-col gap-6 justify-center text-center items-center max-w-[90%] px-4 py-8'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
        <div className='p-4 md:order-1'>
          <img src="/it-solution.jpg" alt="custom-it-solution" className='w-full h-48 object-cover rounded-lg shadow-lg transition-transform duration-300 hover:scale-105' />
          <div className='mt-2'>
        ...
        <div className='p-4'>
          <img src="/e-commerce-solution.jpg" alt="e-commerce-solution" className='w-full h-48 object-cover rounded-lg shadow-lg transition-transform duration-300 hover:scale-105' />
          <div className='mt-2'>
        ...
        <div className='p-4 md:row-span-2'>
          <img src="/feature.jpg" alt="feature-image" className='w-full h-full object-cover rounded-lg shadow-lg transition-transform duration-300 hover:scale-105' />
        </div>
        <div className='p-4'>
          <img src="/graphic-design.jpeg" alt="graphic-design" className='w-full h-48 object-cover rounded-lg shadow-lg transition-transform duration-300 hover:scale-105' />
          <div className='mt-2'>
        ...
        <div className='p-4 '>
          <img src="/digital-marketing.jpg" alt="digital-marketing" className='w-full h-48 object-cover rounded-lg shadow-lg transition-transform duration-300 hover:scale-105' />
          <div className='mt-2'>
